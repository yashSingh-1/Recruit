...
import { CreatingAJobApplication } from "@/server/PrismaServerActions";
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      const createApplication = await CreatingAJobApplication({
        userWhoHasAppliedId: userId!,
        candidateName: values.candidateName,
        resume :values.resume,
        coverLetter: values.coverLetter,
        Age: values.Age,
        WhyDoYouWannaWorkHere: values.WhyDoYouWannaWorkHere,
        UniqueThingsYouGot: values.UniqueThingsYouGot,
        CGPA: values.CGPA,
    ...
    console.log("user id from the local stoeage", userId)
    console.log(values);
  }
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-r from-red-200 via-white to-blue-200">
...

      {
        ...
        <p className="text-black text-3xl font-mono">Submitting the Job!</p>
      </div>
        :
